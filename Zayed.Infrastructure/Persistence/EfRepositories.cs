...
public sealed class EfAccountRepository : IAccountRepository
{
    ...
    public EfAccountRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfAccountingTransactionRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfCustomerRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfEstimateRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfVendorRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfItemRepository(ZayedDbContext db) => _db = db;
...
{
    protected readonly ZayedDbContext Db;
    protected EfDocumentRepository(ZayedDbContext db) => Db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfInvoiceRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfPaymentRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfPurchaseBillRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfInventoryReceiptRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfPurchaseOrderRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfVendorPaymentRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfSalesReturnRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfSalesOrderRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfPurchaseReturnRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfCustomerCreditActivityRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfVendorCreditActivityRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfInventoryAdjustmentRepository(ZayedDbContext db) => _db = db;
...
{
    private readonly ZayedDbContext _db;
    public EfJournalEntryRepository(ZayedDbContext db) => _db = db;
