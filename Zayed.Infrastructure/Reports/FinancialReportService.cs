...
public sealed class FinancialReportService : IFinancialReportService
{
    ...
    private async Task<(List<Zayed.Core.Accounting.Account> Accounts, Dictionary<Guid, (decimal TotalDebit, decimal TotalCredit)> Balances)>
        LoadBalancesAsync(
            DateOnly asOfDate,
            bool includeInactiveAccounts,
