...
$DatabasePath = Join-Path $SmokeRoot "zayed-sales-receipts.db"
...
try {
    ...
    Assert-True (-not [string]::IsNullOrWhiteSpace($receipt.invoiceNumber)) "Sales receipt should get a document number."
