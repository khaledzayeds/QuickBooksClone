...
public static class ModuleSeedCatalog
{
    ...
    [
        ...
        Menu("00000000-0000-0000-0002-000000000017", ModuleCodes.HotelAgents, null, "وكلاء الفنادق", "Hotel Agents", "/hotels/agents", "agent", 605),
        Menu("00000000-0000-0000-0002-000000000018", ModuleCodes.HotelRoomTypes, null, "أنواع الغرف", "Room Types", "/hotels/room-types", "rooms", 606),
        Menu("00000000-0000-0000-0002-000000000019", ModuleCodes.HotelMealPlans, null, "خطط الوجبات", "Meal Plans", "/hotels/meal-plans", "meal", 607),
        Menu("00000000-0000-0000-0002-000000000020", ModuleCodes.HotelContracts, null, "عقود الفنادق", "Hotel Contracts", "/hotels/contracts", "contract", 610),
        Menu("00000000-0000-0000-0002-000000000021", ModuleCodes.HotelAllotment, null, "300 - حصة الفندق", "300 - Hotel Allotment", "/hotels/allotment/hotel", "hotel", 620),
        Menu("00000000-0000-0000-0002-000000000029", ModuleCodes.HotelAllotment, null, "301 - حصة الوكيل", "301 - Agent Allotment", "/hotels/allotment/agent", "agent", 621),
        Menu("00000000-0000-0000-0002-000000000030", ModuleCodes.HotelAllotment, null, "302 - زيادة حصة الفندق", "302 - Hotel Over Allotment", "/hotels/over-allotment/hotel", "hotel", 622),
        Menu("00000000-0000-0000-0002-000000000031", ModuleCodes.HotelAllotment, null, "303 - زيادة حصة الوكيل", "303 - Agent Over Allotment", "/hotels/over-allotment/agent", "agent", 623),
