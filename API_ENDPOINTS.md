...
- SQL Server now uses a separate EF Core migrations assembly: `Zayed.SqlServerMigrations`.
- Sample SQL Server configuration lives in `Zayed.Api/appsettings.SqlServer.example.json`.
