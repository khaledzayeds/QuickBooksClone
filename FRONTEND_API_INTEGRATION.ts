...
export const API_ENDPOINTS = {
  ...
  "PayrollSetup.CreateDeductionType": { method: "POST", path: "/api/payroll/setup/deduction-types", auth: "Payroll.Manage" },
  "PayrollSetup.CreateEarningType": { method: "POST", path: "/api/payroll/setup/earning-types", auth: "Payroll.Manage" },
  "PayrollSetup.CreateEmployee": { method: "POST", path: "/api/payroll/setup/employees", auth: "Payroll.Manage" },
  "PayrollSetup.GetSetup": { method: "GET", path: "/api/payroll/setup", auth: "Payroll.Manage" },
  "PayrollSetup.UpdateSettings": { method: "PUT", path: "/api/payroll/setup/settings", auth: "Payroll.Manage" },
