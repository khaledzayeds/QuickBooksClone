...
public interface IItemRepository
{
    ...
    Task<Item?> UpdateAsync(Guid id, string name, ItemType itemType, string? sku, string? barcode, decimal salesPrice, decimal purchasePrice, string unit, CancellationToken cancellationToken = default);
