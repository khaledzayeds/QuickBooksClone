...
builder.Services.AddSingleton<ICustomerCreditPostingService, CustomerCreditPostingService>();
...
builder.Services.AddSingleton<IInventoryAdjustmentRepository, InMemoryInventoryAdjustmentRepository>();
builder.Services.AddSingleton<IInventoryAdjustmentPostingService, InventoryAdjustmentPostingService>();
builder.Services.AddSingleton<IJournalEntryRepository, InMemoryJournalEntryRepository>();
builder.Services.AddSingleton<IJournalEntryPostingService, JournalEntryPostingService>();
...
builder.Services.AddSingleton<IPurchaseReturnRepository, InMemoryPurchaseReturnRepository>();
builder.Services.AddSingleton<IPurchaseReturnPostingService, PurchaseReturnPostingService>();
