...
class TemplateFieldRegistry {
  static const fields = <TemplateFieldInfo>[
    ...
    TemplateFieldInfo(key: '{{Invoice.Tax}}', label: 'Tax', group: 'Invoice', sampleValue: '175.00'),
    TemplateFieldInfo(key: '{{Invoice.Discount}}', label: 'Discount', group: 'Invoice', sampleValue: '50.00'),
