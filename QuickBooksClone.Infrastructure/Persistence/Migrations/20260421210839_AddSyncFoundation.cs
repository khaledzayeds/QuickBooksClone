...
{
    /// <inheritdoc />
    public partial class AddSyncFoundation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                ...
                UPDATE invoices
                SET DeviceId = 'DEV01',
                    DocumentNo = COALESCE(NULLIF(InvoiceNumber, ''), 'DEV01-LEGACY-' || substr(Id, 1, 8)),
                    SyncStatus = 0
                WHERE IFNULL(DeviceId, '') = '' OR IFNULL(DocumentNo, '') = '';

                UPDATE payments
                SET DeviceId = 'DEV01',
                    DocumentNo = COALESCE(NULLIF(PaymentNumber, ''), 'DEV01-LEGACY-' || substr(Id, 1, 8)),
                    SyncStatus = 0
                WHERE IFNULL(DeviceId, '') = '' OR IFNULL(DocumentNo, '') = '';

                UPDATE purchase_bills
                SET DeviceId = 'DEV01',
                    DocumentNo = COALESCE(NULLIF(BillNumber, ''), 'DEV01-LEGACY-' || substr(Id, 1, 8)),
                    SyncStatus = 0
                WHERE IFNULL(DeviceId, '') = '' OR IFNULL(DocumentNo, '') = '';

                UPDATE purchase_orders
                SET DeviceId = 'DEV01',
                    DocumentNo = COALESCE(NULLIF(OrderNumber, ''), 'DEV01-LEGACY-' || substr(Id, 1, 8)),
                    SyncStatus = 0
                WHERE IFNULL(DeviceId, '') = '' OR IFNULL(DocumentNo, '') = '';

                UPDATE purchase_returns
                SET DeviceId = 'DEV01',
                    DocumentNo = COALESCE(NULLIF(ReturnNumber, ''), 'DEV01-LEGACY-' || substr(Id, 1, 8)),
                    SyncStatus = 0
                WHERE IFNULL(DeviceId, '') = '' OR IFNULL(DocumentNo, '') = '';
                ...
                SET DeviceId = 'DEV01',
                    DocumentNo = COALESCE(NULLIF(AdjustmentNumber, ''), 'DEV01-LEGACY-' || substr(Id, 1, 8)),
                    SyncStatus = 0
                WHERE IFNULL(DeviceId, '') = '' OR IFNULL(DocumentNo, '') = '';

                UPDATE journal_entries
                SET DeviceId = 'DEV01',
                    DocumentNo = COALESCE(NULLIF(EntryNumber, ''), 'DEV01-LEGACY-' || substr(Id, 1, 8)),
                    SyncStatus = 0
                WHERE IFNULL(DeviceId, '') = '' OR IFNULL(DocumentNo, '') = '';

                UPDATE customer_credit_activities
                SET DeviceId = 'DEV01',
                    DocumentNo = COALESCE(NULLIF(ReferenceNumber, ''), 'DEV01-LEGACY-' || substr(Id, 1, 8)),
                    SyncStatus = 0
                WHERE IFNULL(DeviceId, '') = '' OR IFNULL(DocumentNo, '') = '';
            ...
            migrationBuilder.Sql(
                ...
                SELECT 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'DEV01', 'Primary Device', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
                WHERE NOT EXISTS (SELECT 1 FROM device_settings);
                """);
