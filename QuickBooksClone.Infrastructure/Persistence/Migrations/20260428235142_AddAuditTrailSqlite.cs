...
{
    /// <inheritdoc />
    public partial class AddAuditTrailSqlite : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HttpMethod = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Path = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    StatusCode = table.Column<int>(type: "INTEGER", nullable: false),
                    Controller = table.Column<string>(type: "TEXT", maxLength: 160, nullable: true),
                    EndpointAction = table.Column<string>(type: "TEXT", maxLength: 160, nullable: true),
                    RequiredPermissions = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
