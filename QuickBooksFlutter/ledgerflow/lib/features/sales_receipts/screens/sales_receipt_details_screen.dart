// sales_receipt_details_screen.dart
...
class SalesReceiptDetailsScreen extends ConsumerWidget {
  const SalesReceiptDetailsScreen({super.key, required this.id});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final receiptAsync = ref.watch(salesReceiptDetailsProvider(id));
                ...
                Wrap(
                  ...
                  children: [
                    _InfoTile(
                      ...
                      value: _formatDate(receipt.receiptDate),
                    ),
                    _InfoTile(
...
class _LinesTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (lines.isEmpty) {
      return Text(l10n.noRecentTransactions);
    }
