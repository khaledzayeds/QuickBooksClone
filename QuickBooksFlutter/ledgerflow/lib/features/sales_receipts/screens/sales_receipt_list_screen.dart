// sales_receipt_list_screen.dart
...
class SalesReceiptListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final receiptsAsync = ref.watch(salesReceiptsProvider);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            tooltip: l10n.retry,
            onPressed: () => ref.read(salesReceiptsProvider.notifier).refresh(),
      ...
      body: receiptsAsync.when(
        ...
        error: (error, _) => _ErrorState(
          ...
          onRetry: () => ref.read(salesReceiptsProvider.notifier).refresh(),
        ),
        data: (receipts) {
          if (receipts.isEmpty) {
