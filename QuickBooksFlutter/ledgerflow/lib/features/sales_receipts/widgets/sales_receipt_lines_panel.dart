...
class _SalesReceiptFooter extends StatelessWidget {
  const _SalesReceiptFooter({
    required this.totals,
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final memo = referenceField ?? const _MemoPlaceholder();
...
class _MemoPlaceholder extends StatelessWidget {
  const _MemoPlaceholder();
