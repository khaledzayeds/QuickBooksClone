...
class AppConstants {
  ...
  static const dataRootFolderName = 'Zayed';
  ...
  static const defaultCompanyDatabaseFileName = 'zayed.db';
  static const companyFileExtension = '.zayed';
}
