...
class _VendorPaymentListScreenState
        ...
        child: Column(
          children: [
              ...
              child: Row(
                children: [
                  ...
                  _Tool(
                    ...
                    label: 'New',
                    onTap: () => context.push(AppRoutes.vendorPaymentNew),
                  ),
                  _Tool(
                    icon: Icons.refresh,
                    label: 'Refresh',
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        hintText: 'Search payment #, vendor, account...',
            ...
            Container(
              ...
              child: Text(
                'Vendor Payments search  •  Enter opens payment workspace  •  Esc Close',
  ...
  List<VendorPaymentModel> _filter(List<VendorPaymentModel> payments) {
    final query = _queryCtrl.text.trim().toLowerCase();
    return payments.where((payment) {
      if (_selectedStatus != 0 && payment.status != _selectedStatus) {
        return false;
      }
      ...
      return payment.paymentNumber.toLowerCase().contains(query) ||
          ...
          payment.paymentAccountName.toLowerCase().contains(query) ||
          (payment.memo ?? '').toLowerCase().contains(query);
