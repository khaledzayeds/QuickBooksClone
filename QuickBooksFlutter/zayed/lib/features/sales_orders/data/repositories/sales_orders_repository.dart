...
class SalesOrdersRepository {
  ...
  Future<ApiResult<SalesOrderModel>> getById(String id) =>
      _datasource.getById(id);

  Future<ApiResult<SalesOrderModel>> create(CreateSalesOrderDto dto) =>
  ...
  Future<ApiResult<SalesOrderModel>> cancel(String id) =>
      _datasource.cancel(id);

  Future<ApiResult<InvoiceModel>> convertToInvoice(String id) =>
      _datasource.convertToInvoice(id);
}
