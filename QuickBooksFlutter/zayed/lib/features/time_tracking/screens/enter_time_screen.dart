          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                const Text(
                  'Zayed creates the invoice, validates selected entries, posts it if selected, and links the time entries.',
                ),
                const SizedBox(height: 18),
                DropdownButtonFormField<String>(
      ...
      builder: (context, setState) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              'If an invoice ID is provided, Zayed checks it before linking the time entry.',
            ),
            const SizedBox(height: 18),
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
