...
class SecurityUserRoleModel {
  ...
  factory SecurityUserRoleModel.fromJson(Map<String, dynamic> json) =>
      SecurityUserRoleModel(
...
class SecurityUserModel {
  ...
  factory SecurityUserModel.fromJson(Map<String, dynamic> json) =>
      SecurityUserModel(
        id: json['id']?.toString() ?? '',
        ...
        roles: (json['roles'] as List? ?? const [])
            ...
            .map(SecurityUserRoleModel.fromJson)
            .toList(),
        effectivePermissions:
            (json['effectivePermissions'] as List? ?? const [])
                .map((item) => item.toString())
                .toList(),
      );
}
...
class SecurityRoleListResult {
  ...
  factory SecurityRoleListResult.fromJson(Map<String, dynamic> json) =>
      SecurityRoleListResult(
        items: (json['items'] as List? ?? const [])
            .whereType<Map<String, dynamic>>()
            .map(SecurityRoleModel.fromJson)
            .toList(),
...
class SecurityUserListResult {
  ...
  factory SecurityUserListResult.fromJson(Map<String, dynamic> json) =>
      SecurityUserListResult(
        items: (json['items'] as List? ?? const [])
            .whereType<Map<String, dynamic>>()
            .map(SecurityUserModel.fromJson)
            .toList(),
        totalCount: _int(json['totalCount']),
        page: _int(json['page'], fallback: 1),
        pageSize: _int(json['pageSize'], fallback: 25),
