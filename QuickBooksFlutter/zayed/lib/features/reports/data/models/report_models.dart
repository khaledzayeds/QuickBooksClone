  ...
  factory TrialBalanceReportModel.fromJson(Map<String, dynamic> json) =>
      TrialBalanceReportModel(
        ...
        items: JsonUtils.asList(
          json['items'],
          (row) => TrialBalanceRowModel.fromJson(row),
        ),
  ...
  factory TrialBalanceRowModel.fromJson(Map<String, dynamic> json) =>
      TrialBalanceRowModel(
        ...
        accountType: AccountType.fromValue(
          JsonUtils.asInt(json['accountType'], defaultValue: 14),
        ),
        totalDebit: JsonUtils.asDouble(json['totalDebit']),
        totalCredit: JsonUtils.asDouble(json['totalCredit']),
...
class FinancialStatementReportModel {
  ...
  factory FinancialStatementReportModel.fromBalanceSheetJson(
    Map<String, dynamic> json,
  ) => FinancialStatementReportModel(
    asOfDate: _parseDate(json['asOfDate']),
    sections: JsonUtils.asList(
      json['sections'],
      (section) => FinancialSectionModel.fromJson(section),
    ),
    ...
    totalLiabilitiesAndEquity: JsonUtils.asDouble(
      json['totalLiabilitiesAndEquity'],
    ),
  );
}
...
class FinancialSectionModel {
  ...
  factory FinancialSectionModel.fromJson(Map<String, dynamic> json) =>
      FinancialSectionModel(
        key: JsonUtils.asString(json['key']),
        title: JsonUtils.asString(json['title']),
        items: JsonUtils.asList(
          json['items'],
          (item) => FinancialRowModel.fromJson(item),
        ),
...
class FinancialRowModel {
  ...
  factory FinancialRowModel.fromJson(Map<String, dynamic> json) =>
      FinancialRowModel(
        accountId: JsonUtils.asString(json['accountId']),
        accountCode: JsonUtils.asString(json['accountCode']),
        accountName: JsonUtils.asString(json['accountName']),
...
class AgingReportModel {
  ...
  factory AgingReportModel.fromJson(Map<String, dynamic> json) =>
      AgingReportModel(
        asOfDate: _parseDate(json['asOfDate']),
        items: JsonUtils.asList(
          json['items'],
          (row) => AgingRowModel.fromJson(row),
        ),
...
class AgingRowModel {
  ...
  factory AgingRowModel.fromJson(Map<String, dynamic> json) => AgingRowModel(
    ...
    openCount: JsonUtils.asInt(
      json['openInvoiceCount'] ?? json['openBillCount'],
    ),
  );
}
...
class InventoryValuationReportModel {
  const InventoryValuationReportModel({
    ...
    required this.toDate,
    required this.items,
    required this.totalClosingValue,
  });
  ...
  factory InventoryValuationReportModel.fromJson(Map<String, dynamic> json) =>
      InventoryValuationReportModel(
        ...
        items: JsonUtils.asList(
          json['items'],
          (row) => InventoryValuationRowModel.fromJson(row),
        ),
...
class InventoryValuationRowModel {
  const InventoryValuationRowModel({
  ...
  factory InventoryValuationRowModel.fromJson(Map<String, dynamic> json) =>
      InventoryValuationRowModel(
...
class TaxSummaryReportModel {
  ...
  factory TaxSummaryReportModel.fromJson(Map<String, dynamic> json) =>
      TaxSummaryReportModel(
        fromDate: _parseDate(json['fromDate']),
        toDate: _parseDate(json['toDate']),
        items: JsonUtils.asList(
          json['items'],
          (row) => TaxSummaryRowModel.fromJson(row),
        ),
...
class TaxSummaryRowModel {
  ...
  factory TaxSummaryRowModel.fromJson(Map<String, dynamic> json) =>
      TaxSummaryRowModel(
...
class SalesSummaryReportModel {
  ...
  factory SalesSummaryReportModel.fromJson(Map<String, dynamic> json) =>
      SalesSummaryReportModel(
        ...
        byStatus: JsonUtils.asList(
          json['byStatus'],
          (row) => SalesSummaryByStatusModel.fromJson(row),
        ),
        byCustomer: JsonUtils.asList(
          json['byCustomer'],
          (row) => SalesSummaryByCustomerModel.fromJson(row),
        ),
        invoices: JsonUtils.asList(
          json['invoices'],
          (row) => SalesSummaryInvoiceModel.fromJson(row),
        ),
      );
}

class SalesSummaryByStatusModel {
  const SalesSummaryByStatusModel({
  ...
  final double paidAmount;
  final double balanceDue;
  factory SalesSummaryByStatusModel.fromJson(Map<String, dynamic> json) =>
      SalesSummaryByStatusModel(
...
class SalesSummaryByCustomerModel {
  const SalesSummaryByCustomerModel({
  ...
  final double paidAmount;
  final double balanceDue;
  factory SalesSummaryByCustomerModel.fromJson(Map<String, dynamic> json) =>
      SalesSummaryByCustomerModel(
...
class SalesSummaryInvoiceModel {
  const SalesSummaryInvoiceModel({
    required this.id,
  ...
  final double paidAmount;
  final double balanceDue;
  factory SalesSummaryInvoiceModel.fromJson(Map<String, dynamic> json) =>
      SalesSummaryInvoiceModel(
...
class PurchasesSummaryReportModel {
  ...
  factory PurchasesSummaryReportModel.fromJson(Map<String, dynamic> json) =>
      PurchasesSummaryReportModel(
        ...
        byStatus: JsonUtils.asList(
          json['byStatus'],
          (row) => PurchasesSummaryByStatusModel.fromJson(row),
        ),
        byVendor: JsonUtils.asList(
          json['byVendor'],
          (row) => PurchasesSummaryByVendorModel.fromJson(row),
        ),
        bills: JsonUtils.asList(
          json['bills'],
          (row) => PurchasesSummaryBillModel.fromJson(row),
        ),
      );
}

class PurchasesSummaryByStatusModel {
  const PurchasesSummaryByStatusModel({
    required this.status,
    required this.billCount,
    required this.totalAmount,
    required this.paidAmount,
  ...
  final double paidAmount;
  final double balanceDue;
  factory PurchasesSummaryByStatusModel.fromJson(Map<String, dynamic> json) =>
      PurchasesSummaryByStatusModel(
        status: JsonUtils.asInt(json['status']),
        billCount: JsonUtils.asInt(json['billCount']),
        totalAmount: JsonUtils.asDouble(json['totalAmount']),
        paidAmount: JsonUtils.asDouble(json['paidAmount']),
...
class PurchasesSummaryByVendorModel {
  const PurchasesSummaryByVendorModel({
  ...
  final double paidAmount;
  final double balanceDue;
  factory PurchasesSummaryByVendorModel.fromJson(Map<String, dynamic> json) =>
      PurchasesSummaryByVendorModel(
...
class PurchasesSummaryBillModel {
  const PurchasesSummaryBillModel({
    required this.id,
  ...
  final double paidAmount;
  final double balanceDue;
  factory PurchasesSummaryBillModel.fromJson(Map<String, dynamic> json) =>
      PurchasesSummaryBillModel(
        id: JsonUtils.asString(json['id']),
