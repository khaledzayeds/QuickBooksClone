...
// Fully localized and aligned with Zayed aesthetic.
...
class ReceiveInventoryDetailsScreen extends ConsumerWidget {
  ...
  bool _isVoidStatus(String status) =>
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _InfoRow(
                        label: 'Receipt Mode',
                        value: isFromPo ? 'From Purchase Order' : 'Standalone',
                      ),
                      if (isFromPo)
                        _InfoRow(
                      ...
                      if (receipt.notes != null && receipt.notes!.isNotEmpty)
                        _InfoRow(label: l10n.notes, value: receipt.notes!),
                    ],
                  ),
                ),
              ),
                ...
                ...receipt.lines.map(
                  (line) => Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        line.purchaseOrderLineId == null
                            ? 'Manual line • ID: ${line.itemId.substring(0, 8)}…'
                            : 'PO-linked line • ID: ${line.itemId.substring(0, 8)}…',
                      ),
                      trailing: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${line.unitCost.toStringAsFixed(2)} / unit',
                            style: const TextStyle(
                              fontSize: 10,
                              color: Colors.grey,
                            ),
