...
class SalesReturnListScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SalesReturnListScreen> createState() =>
...
class _SalesReturnListScreenState
        ...
        child: Column(
          children: [
              ...
              child: Row(
                children: [
                  ...
                  _Tool(
                    ...
                    label: 'New',
                    onTap: () => context.push(AppRoutes.salesReturnNew),
                  ),
                  _Tool(
                    icon: Icons.refresh,
                    label: 'Refresh',
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        hintText: 'Search return #, customer, invoice...',
                                ...
                                return InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        _Cell(
                                          _fmtDate(salesReturn.returnDate),
                                          flex: 2,
                                        ),
                                        _Cell(
                                        ...
                                        _Cell(
                                          _fmtMoney(salesReturn.totalAmount),
                                          flex: 2,
                                          right: true,
                                          strong: true,
                                        ),
            ...
            Container(
              ...
              child: Text(
                'Sales Returns search  •  Enter opens return workspace  •  Esc Close',
  ...
  List<SalesReturnModel> _filter(List<SalesReturnModel> returns) {
    final query = _queryCtrl.text.trim().toLowerCase();
    return returns.where((salesReturn) {
      if (_selectedStatus != 0 && salesReturn.status != _selectedStatus) {
        return false;
      }

      final range = _dateRange;
      if (range != null) {
        final date = DateUtils.dateOnly(salesReturn.returnDate);
      ...
      return salesReturn.returnNumber.toLowerCase().contains(query) ||
          (salesReturn.customerName ?? '').toLowerCase().contains(query) ||
          (salesReturn.invoiceNumber ?? '').toLowerCase().contains(query);
