...
class SalesPostingPreviewModel {
  const SalesPostingPreviewModel({
    ...
    this.lines = const [],
    this.ledgerImpacts = const [],
    this.inventoryImpacts = const [],
    this.warnings = const [],
  });
  ...
  factory SalesPostingPreviewModel.fromJson(Map<String, dynamic> json) =>
      SalesPostingPreviewModel(
        ...
        lines: JsonUtils.asList(
          json['lines'],
          (line) => SalesPostingPreviewLineModel.fromJson(line),
        ),
        ledgerImpacts: JsonUtils.asList(
          json['ledgerImpacts'],
          (impact) => SalesLedgerImpactModel.fromJson(impact),
        ),
        inventoryImpacts: JsonUtils.asList(
          json['inventoryImpacts'],
          (impact) => SalesInventoryImpactModel.fromJson(impact),
        ),
...
class SalesPostingPreviewLineModel {
  const SalesPostingPreviewLineModel({
    required this.itemId,
  ...
  factory SalesPostingPreviewLineModel.fromJson(Map<String, dynamic> json) =>
      SalesPostingPreviewLineModel(
        ...
        currentStock: json['currentStock'] == null
            ? null
            : JsonUtils.asDouble(json['currentStock']),
        projectedStock: json['projectedStock'] == null
            ? null
            : JsonUtils.asDouble(json['projectedStock']),
        grossMargin: json['grossMargin'] == null
            ? null
            : JsonUtils.asDouble(json['grossMargin']),
        warnings: (json['warnings'] as List? ?? [])
            .map((e) => e.toString())
            .toList(),
      );
...
class SalesLedgerImpactModel {
  ...
  factory SalesLedgerImpactModel.fromJson(Map<String, dynamic> json) =>
      SalesLedgerImpactModel(
...
class SalesInventoryImpactModel {
  const SalesInventoryImpactModel({
    required this.itemId,
    required this.itemName,
  ...
  factory SalesInventoryImpactModel.fromJson(Map<String, dynamic> json) =>
      SalesInventoryImpactModel(
        itemId: JsonUtils.asString(json['itemId']),
        itemName: JsonUtils.asString(json['itemName']),
...
class CustomerSalesActivityModel {
  const CustomerSalesActivityModel({
    required this.customerId,
    ...
    this.recentSalesReceipts = const [],
  ...
  factory CustomerSalesActivityModel.fromJson(Map<String, dynamic> json) =>
      CustomerSalesActivityModel(
        ...
        recentInvoices: JsonUtils.asList(
          json['recentInvoices'],
          (item) => CustomerSalesActivityItemModel.fromJson(item),
        ),
        recentSalesReceipts: JsonUtils.asList(
          json['recentSalesReceipts'],
          (item) => CustomerSalesActivityItemModel.fromJson(item),
        ),
        recentPayments: JsonUtils.asList(
          json['recentPayments'],
          (item) => CustomerPaymentActivityItemModel.fromJson(item),
        ),
        warnings: (json['warnings'] as List? ?? [])
            .map((e) => e.toString())
            .toList(),
...
class CustomerSalesActivityItemModel {
  const CustomerSalesActivityItemModel({
    required this.id,
  ...
  factory CustomerSalesActivityItemModel.fromJson(Map<String, dynamic> json) =>
      CustomerSalesActivityItemModel(
...
class CustomerPaymentActivityItemModel {
  const CustomerPaymentActivityItemModel({
    required this.id,
    required this.number,
  ...
  factory CustomerPaymentActivityItemModel.fromJson(
    Map<String, dynamic> json,
  ) => CustomerPaymentActivityItemModel(
    id: JsonUtils.asString(json['id']),
    number: JsonUtils.asString(json['number']),
